...
- **channel-routing.json:** `~/clawd/clawd-prj/kung-fu/config/channel-routing.json` — auto-bind experts to Slack channels
...
3. **Docs updated** — `docs/roles/index.md` (all 14 experts), `README.md` (table + docs index), new `docs/howto/channel-routing.md`, new `docs/howto/improving-experts.md`, fixed `docs/howto/loading.md` stale flags, fixed `CONTRIBUTING.md` broken path
...
- [ ] Write PLAYBOOK.md template/guide for Wego rollout
